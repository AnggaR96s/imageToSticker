...
module.exports = msgHandler = async (client = new Client(), message) => {
    try {
        ...
        case 'facebook':
            ...
            await client.reply(from, '_Scraping Metadata..._ \n\nTerimakasih telah menggunakan bot ini, kamu dapat membantu pengembangan bot ini dengan menyawer melalui https://saweria.co/donate/anggars atau mentrakteer melalui https://trakteer.id/anggars \nTerimakasih.', id)
